...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const now = new Date();
  const staticPaths = ["", "/destinations", "/wizard", "/green-card", "/blog", "/foto-poziadavky", "/stav", "/kontakt", "/pre-firmy", "/partnersky-program", "/ochrana-kupujuceho", "/obchodne-podmienky", "/reklamacie", "/ochrana-osobnych-udajov", "/cookies"];
  return [

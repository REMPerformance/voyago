...
export function Faq() {
  ...
  const items = [
    ...
    { q: t({ sk: "Čo ak žiadosť zamietnu?", en: "What if my application is refused?" }), a: t({ sk: "Každú žiadosť pred podaním kontrolujeme, aby sme riziko minimalizovali. Ak by k zamietnutiu došlo, poradíme vám ďalší postup. S doplnkom Ochrana kupujúceho (10 €) vám pri zamietnutí vrátime celú pôvodnú sumu.", en: "We review every application before filing to minimise risk. If a refusal happens, we advise you on next steps. With Buyer Protection (€10) we refund the full original amount on refusal." }) },

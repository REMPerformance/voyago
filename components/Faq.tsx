...
export function Faq() {
  ...
  const items = [
    ...
    { q: t({ sk: "Čo je zahrnuté v cene?", en: "What is included in the price?" }), a: t({ sk: "Cena je konečná a vrátane DPH. Pokrýva kompletné vybavenie: ručnú kontrolu údajov oproti pasu, posúdenie fotografie podľa noriem, podanie žiadosti na oficiálnom portáli, sledovanie stavu a podporu počas celej platnosti povolenia. Nič sa nedopláca a sumu poznáte vopred.", en: "The price is final and includes VAT. It covers the complete service: a manual check against your passport, photo assessment against the standards, filing on the official portal, status tracking and support for the whole validity. Nothing is added later and you know the amount upfront." }) },
  ];
